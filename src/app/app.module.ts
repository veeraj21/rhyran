...
@NgModule({
  declarations: [ AppComponent, LoginComponent,  TeamComponent, ContactComponent, ReviewsComponent, HomeComponent,
      ServicesComponent,JobDetailComponent, JobComponent,HighlightDirective,SummaryPipe,SortPipe, FavoriteComponent, 
      AppInputFormatDirective, ConsultantComponent,ConsultantDetailComponent],
